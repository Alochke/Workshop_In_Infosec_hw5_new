...
sed -i 's/$logfile = escapeshellcmd($_POST['logfile']);/$logfile = $_POST['logfile']/' /var/www/html/ajax/logging/clearlog.php
sed -i 's/$ovpncfg_id = escapeshellcmd($_POST['cfg_id']);/$ovpncfg_id = $_POST['cfg_id'];/' /var/www/html/ajax/openvpn/activate_ovpncfg.php
sed -i 's/$ovpncfg_id = escapeshellcmd($_POST['cfg_id']);/$ovpncfg_id = $_POST['cfg_id'];/' /var/www/html/ajax/openvpn/del_ovpncfg.php
